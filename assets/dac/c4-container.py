...
with Diagram("Container Diagram For Profio Logistics Application",
             direction="TB",
    ...
    with SystemBoundary("Profio Logistics Application"):
        ...
        api = Container(
            ...
            description=
            "The API that provides data to the web application and driver application",
        )
        ...
        cache = Database(
            ...
            technology="Redis",
            description=
            "The cache that stores data for the web application and driver application",
        )
    ...
    customer >> Relationship(
        "Visits the web application using [HTTPS]") >> webapp
    staff >> Relationship("Manages system]") >> [cms, driverapp]
    [webapp, cms, driverapp
     ] >> Relationship("Makes api call using [JSON/HTTPS]") >> api
