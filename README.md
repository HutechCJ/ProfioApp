...
<blockquote>
	<p align="justify">
		If the sebp/elk image is not running, you can have to set the <code>vm.max_map_count</code> kernel setting to at least <code>262144</code>. To do this, execute the <code>update_sysctl.sh</code> script in the WSL terminal.
	</p>
</blockquote>
...
<p align="justify">
	We have implemented ReDoc with the OpenAPI specification is a great way to generate documentation for your API quickly and easily. You can read more about ReDoc <a href="https://profioapp.azurewebsites.net/" target="_blank">here</a>.
</p>
...
<p align="justify">
We also used the, <b>Zipkin</b> service to collect and analyze traces.
</p>
...
<p align="justify">
We set up the <b>Elasticsearch</b>, <b>Kibana</b> and <b>Logstash</b> services to collect and analyze logs.
</p>

<img loading="lazy" src="./assets/img/ELK.png" width="100%" alt="ELK">
