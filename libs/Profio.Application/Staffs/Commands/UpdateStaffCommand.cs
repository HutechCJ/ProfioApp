...
public record UpdateStaffCommand(object Id) : UpdateCommandBase(Id)
{
...
public class UpdateStaffCommandHandler : UpdateCommandHandlerBase<UpdateStaffCommand, Staff>
{
