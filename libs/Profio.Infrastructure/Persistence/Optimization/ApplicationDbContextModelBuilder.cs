...
namespace Profio.Infrastructure.Persistence.Optimization
{
    public partial class ApplicationDbContextModel
    {
        partial void Initialize()
        {
            ...
            var phase = PhaseEntityType.Create(this);
            ...
            IncidentEntityType.CreateForeignKey1(incident, delivery);
            OrderEntityType.CreateForeignKey1(order, customer);
            OrderEntityType.CreateForeignKey2(order, phase);
            PhaseEntityType.CreateForeignKey1(phase, route);
            ...
            ApplicationUserEntityType.CreateForeignKey1(applicationUser, staff);
            ...
            PhaseEntityType.CreateAnnotations(phase);
